...
def build_router(
    ...
    async def status(message: Message) -> None:
        ...
        await message.answer(
            ...
            f"PRE-MOVE подготовка: {'✅ авто' if settings.prepare_alerts_enabled else '❌'} "
            f"· score ≥ {settings.prepare_min_score} · "
            f"максимум {settings.prepare_max_alerts_per_day}/сутки\n"
